...
- `/teamstats` — current-season aggregates for everyone in this chat who has linked an Epic account; one leaders table (top-5 by wins) plus three per-mode top-3 tables, rendered as monospace `<pre>` tables
